...
AMapWX.prototype.getWxLocation = function (a, b) {
  ...
  function d (d) {
    var e = 'base'
    a.type && a.type == 'forecast' && (e = 'all'), wx.request({
      ...
      success: function (b) {
        ...
        var d, e
        b.data.status && b.data.status == '1' ? b.data.lives ? (d = b.data.lives, d && d.length > 0 && (d = d[0], e = c(d), e['liveData'] = d, a.success(e))) : b.data.forecasts && b.data.forecasts[0] && a.success({
  ...
  function e (e) {
    wx.request({
      ...
      success: function (b) {
        var c, e
        b.data.status && b.data.status == '1' ? (e = b.data.regeocode, e.addressComponent ? c = e.addressComponent.adcode : e.aois && e.aois.length > 0 && (c = e.aois[0].adcode), d(c)) : a.fail({
          errCode: b.data.infocode,
          errMsg: b.data.info
        })
      },
        ...
        if (b.data.status && b.data.status == '1') {
          if (b = b.data, b && b.pois) {
            for (c = [], d = 0; d < b.pois.length; d++) {
              e = d == 0 ? a.iconPathSelected : a.iconPath, c.push({
